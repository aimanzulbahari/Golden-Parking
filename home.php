...
if (@$_SESSION[$GLOBALS['fw_sistem']]['username'] == '') {
    ...
    <html lang="en">
        ...
        <head>
            <meta charset="utf-8" />
            <title>GPS | MBSA <?php if (in_array(@$_SESSION[$GLOBALS['fw_sistem']]['superadmin'], $GLOBALS['fw_superadmin']) || $server == $url_local) {
        echo $do;
    } ?></title>
                ...
                <div id="header" class="header navbar navbar-default navbar-fixed-top">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="navbar-header">
                            <a href="action.do" class="navbar-brand"><span class="navbar-logo"><i class="fa fa-car"></i></span> <b>My</b>GoldParking</a>
