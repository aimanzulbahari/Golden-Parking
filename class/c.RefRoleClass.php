...
class RefRoleClass {
    ...
    public static function ajaxclick($get = '') {
        $idform = 'RefRoleClass';
        $divajax = 'divRefRoleClass';
        $urlajax = Db::CFAjax('RefRoleClass', 'process');
    ...
    public static function process($data) {
        if (is_array($data)) {
            ...
            $table = 'ref_role';
            $semak = chkwajib($_POST, 'rr_acronym,rr_description,rr_status');
        ...
        ViewRefRoleClass::form_RefRoleClass(@$data);
    }

    public static function sql_listgrid($request) {
        $table = 'ref_role';
        $field = 'rr_id,rr_acronym,rr_description,rr_status';
        $condition = "1=1";
            $order = 'rr_acronym';
